...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <p>Effective date: November 14, 2019</p>

      <p>
        Social Machine ("us", "we", or "our") operates the
        https://social-machine.herokuapp.com/ website (hereinafter referred to
        as the "Service").
      </p>
      ...
      <p>
        ...
        have associated with that data. The Privacy Policy for Social Machine
      ...
      <p>
        ...
        https://social-machine.herokuapp.com/
      </p>
      ...
      <ul>
        <li>
          ...
          <p>
            Service is the https://social-machine.herokuapp.com/ website
            operated by Social Machine
          </p>
        </li>
        <li>
          <p>
      ...
      <p>Social Machine uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        Social Machine will take all steps reasonably necessary to ensure that
      ...
      <p>
        Social Machine may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Social Machine</li>
        <li>
      ...
      <ul>
        <li>By email: social.machine.service@gmail.com</li>
      </ul>
    </div>
  );
};
